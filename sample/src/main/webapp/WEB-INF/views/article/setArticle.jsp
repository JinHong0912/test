...
<body>
    <div id="tbl-spacing">
        <div id="article-top" class="margin-b20">
            <span class="float-l bold font-18 noto">게시물 작성 페이지 입니다.</span>
 		...
 		<table>
			...
			<tr class="tr-50">
				...
				<td class="w-85 padding-lr-10"><input type="text" class="input-full padding-lr-10" name="subject" id="subject" autofocus></td>
			</tr>
