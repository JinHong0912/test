                    ...
                    <body>
                        <div id="tbl-spacing">
                            ...
                            <table>
                                ...
                                <c:forEach var="articleList" items="${articleList}" varStatus="status">
                                    <tr class="tr-50 align font-16 bold noto">
                                        <td><input type="checkbox" name="chk" class="chk" data-code="${boardCode}"
                                                data-aid="${articleList.aid}"></td>
                            ...
                            <div class="page-grp margin-t10">
                                ...
                                <c:if test="${prev}">
                                    <span class="padding-a-10" style="background-color:${boardConfig.boardColor}">
                                        <a href="/article?boardCode=${boardCode}&num=${startPageNum-1}&searchOpt=${searchOpt}&words=${words}&template=${template}&mypage=${mypage}"
                                            class="f6">이전</a>
                                    </span>
                                </c:if>
