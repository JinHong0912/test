                        ...
                        <div class="main-top-box-wrap">
                            <div class="main-top-box box-clr-1 br-3">
                                ...
                                <div class="box-bottom">
                                    <i class="far fa-clock f6"></i> <span class="update-time eng f6 font-12"> Update
                                        02:15 pm </span>
                                </div>
                            </div>
                            <div class="main-top-box box-clr-2 br-3">
                                <div class="box-top">
                                    ...
                                    <div class="item-title float-l">
                                        <div class="item-count">
                                            <span class="font-40 bold f6"> <i class="fas fa-marker"></i> 123
                                            </span>
                                        </div>
                                        <div class="item-tag">
                            ...
                            <div class="main-top-box box-clr-3 br-3">
                                <div class="box-top">
                                    ...
                                    <div class="item-title float-l">
                                        <div class="item-count">
                                            <span class="font-40 bold f6"> <i class="far fa-newspaper"></i> 200
                                            </span>
                                        </div>
                                        <div class="item-tag">
                                            <span class="bold f6"> Member Reg.(Today) </span>
                            ...
                            <div class="main-top-box box-clr-4 br-3">
                                <div class="box-top">
                                    ...
                                    <div class="item-title float-l">
                                        <div class="item-count">
                                            <span class="font-40 bold f6"> <i class="fab fa-product-hunt"></i> 6
                                            </span>
                                        </div>
                                        <div class="item-tag">
                                            <span class="bold f6"> Member Reg.(Today) </span>
