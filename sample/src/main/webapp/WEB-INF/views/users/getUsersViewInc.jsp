    ...
    <div id="member-view" class="margin-t30">
        ...
        <table>
            ...
            <tr class="tr-45">
                ...
                <td class="w-35 padding-lr-5">${usersView.userName}</td>
                <td class="bg-color-5 f6 w-15 align">사용자 권한</td>
                <td class="w-35 padding-lr-5"> </td>
            </tr>
            <tr><td colspan="4" class="tbl-line"></td></tr>
            <tr class="tr-45">
                <td class="bg-color-5 f6 w-15 align">사용자 휴대전화</td>
                <td class="w-35 padding-lr-5">${usersView.userPhone}</td>
            ...
            <tr class="tr-45">
                ...
                <td colspan="3" class="w-85 padding-lr-5">${usersView.userEmail}</td>
            </tr>
            <tr><td colspan="4" class="tbl-line"></td></tr>
            <tr class="tr-45">
                <td class="bg-color-5 f6 w-15 align">사용자 이미지</td>
                <td colspan="3" class="w-85 padding-lr-5"></td>
            </tr>
            <tr><td colspan="4" class="tbl-line"></td></tr>
        ...
        <div class="btn-grp margin-t20">
            <div class="btn-left float-l">
                <button type="button" onclick="location.href='/users?template=users&mypage=list'" class="btn-50 bo-gray bold font-12">목록</button>
            </div>
            <div class="btn-left float-r">
                <button type="button" onclick="location.href='/users/getUsersModify?uid=${usersView.uid}'"
                    class="btn-50 bo-blue bold font-12">수정</button>
                <button type="button" onclick="location.href='/users/setUsersDelete?uid=${usersView.uid}'"
                    class="btn-50 bo-blue bold font-12">삭제</button>
            </div>
